...
def main() -> int:
    ...
    print(report)
    _deliver_telegram([lines1, lines2, lines3, lines4, lines5, lines6, lines7, lines8, lines9, lines10, lines11, lines12, lines13, lines14, lines15, lines16, lines17, lines18, lines19, lines20], out, bool(args.send_telegram))
