...
def run_audit(scanner, canonical: pd.DataFrame, selected: pd.DataFrame, prepared_snapshot_path: str | Path,
    ...
    matrix.to_csv(out/'v49_75_pit_marcap_matrix.csv.gz',index=False,compression='gzip',encoding='utf-8')
    day_meta.to_csv(out/'v49_75_pit_marcap_date_coverage.csv',index=False,encoding='utf-8-sig')
    ...
    current.to_csv(out/'v49_75_pit_marcap_current_raw_enriched.csv.gz',index=False,compression='gzip',encoding='utf-8')
    selected_enriched.to_csv(out/'v49_75_pit_marcap_current_selected_enriched.csv',index=False,encoding='utf-8-sig')
    ...
    shadow_selected.to_csv(out/'v49_75_pit_marcap_one_sided_shadow_top5.csv',index=False,encoding='utf-8-sig')
    ...
    mode_summary.to_csv(out/'v49_75_pit_marcap_strategy_impact.csv',index=False,encoding='utf-8-sig')
    ...
    future.sort_values(['signal_date','mode','code']).to_csv(out/'v49_75_pit_marcap_future_included_cases.csv',columns=future_cols,index=False,encoding='utf-8-sig')
    selected_future.sort_values(['signal_date','mode','code']).to_csv(out/'v49_75_pit_marcap_future_included_selected_cases.csv',index=False,encoding='utf-8-sig')
    ...
    code_summary.to_csv(out/'v49_75_pit_marcap_future_included_code_summary.csv',index=False,encoding='utf-8-sig')
    ...
    (out/'v49_75_pit_marcap_audit_manifest.json').write_text(json.dumps(manifest,ensure_ascii=False,indent=2,default=str),encoding='utf-8')
    return {
