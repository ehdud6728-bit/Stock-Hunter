...
# --- telegram env fallback hotfix ---
try:
    TELEGRAM_REAL_CHAT_ID
except NameError:
    TELEGRAM_REAL_CHAT_ID = os.getenv("TELEGRAM_REAL_CHAT_ID", "") or os.getenv("TELEGRAM_CHAT_ID", "")

try:
    TELEGRAM_TEST_CHAT_ID
except NameError:
    TELEGRAM_TEST_CHAT_ID = os.getenv("TELEGRAM_TEST_CHAT_ID", "") or os.getenv("TELEGRAM_CHAT_ID", "")
