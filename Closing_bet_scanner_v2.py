...
# =============================================================
# closing_bet_scanner.py — 종가배팅 타점 스캐너 (G Morales v4.1.1 DISPLAY FIX 완성형)
# =============================================================
# 전략 구성
# A  : 돌파형 종가배팅
...
CLOSING_BET_SCANNER_VERSION = 'G_MORALES_V4_1_1_DISPLAY_FIX_20260511'
...
def _build_backtest_summary(
    ...
    try:
        ...
        try:
            ...
            if core_only or safe_only or neutral_only or risk_only:
                if safe_only:
                    _scope = 'SAFE 선택군'
                elif neutral_only:
                    _scope = 'NEUTRAL 선택군'
