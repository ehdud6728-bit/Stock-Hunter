...
# =============================================================
# closing_bet_scanner.py — 종가배팅 타점 스캐너 (v4.3.2 I-CORE PHASE/SUPPLY STRICT BACKTEST)
# =============================================================
# 전략 구성
# A  : 돌파형 종가배팅
...
CLOSING_BET_SCANNER_VERSION = 'G_MORALES_V4_3_2_I_CORE_PHASE_SUPPLY_STRICT_BACKTEST_20260515'

# v4.3.2 I-CORE strict/supply options
...
def _format_i_core_report(df: pd.DataFrame) -> str:
    try:
        ...
        lines = []
        lines.append("[📈 I-CORE 시대중심주 150/200일 시세분출 — v4.3.2 STRICT/수급]")
        if i.empty:
        ...
        lines.append("- 뉴스/재료 지속성은 이번 v4.3.0에서는 거래대금·월봉거래량·대표성 프록시로만 측정하며, 후속 버전에서 뉴스 누적 저장소와 연결합니다. v4.3.2는 조건을 엄격화하고 OBV/거래대금 수급프록시 및 선택적 외국인/기관 수급을 함께 봅니다.")
        return "\n".join(lines)
    except Exception as e:
