...
# =============================================================
# closing_bet_scanner.py — 종가배팅 타점 스캐너 (G Morales v4.1.7 G 모랄레스갭 3단계 검증)
# =============================================================
# 전략 구성
# A  : 돌파형 종가배팅
...
CLOSING_BET_SCANNER_VERSION = 'G_MORALES_V4_1_7_G_STAGE_BACKTEST_20260511'
...
def _format_practical_combo_report(df: pd.DataFrame) -> str:
    ...
    try:
        ...
        lines.append("- 해석: 실전 최우선은 S1 우수응축형 중 SAFE 후보입니다. G는 v4.1.7에서 별도 3단계 검증 대상으로 분리합니다.")
    except Exception as e:
...
def _build_backtest_summary(
    ...
    lines.append("- v4.1.7부터 G 모랄레스갭은 G-SAFE/G-NEUTRAL/G-RISK 3단계로 별도 검증합니다. C-SWING은 실전 후보가 아니라 진단용으로 유지합니다.")
