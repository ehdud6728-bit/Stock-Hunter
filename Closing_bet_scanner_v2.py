...
CLOSING_BET_SCANNER_VERSION = 'G_MORALES_V4_4_1_3_DYUL_ROUTE_FIX_NEW_PATTERNS_20260518'
...
# ── 종가배팅 전용 텔레그램 설정
# v4.4.1.3: 기본방 오발송 방지. 실제 Secrets 기준 TELEGRAM_CLOSEBET_TOKEN + TELEGRAM_DYUL_CHAT_ID를 우선 사용한다.
