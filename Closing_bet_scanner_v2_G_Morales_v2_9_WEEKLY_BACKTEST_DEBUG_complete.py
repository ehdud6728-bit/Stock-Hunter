...
# =============================================================
# closing_bet_scanner.py — 종가배팅 타점 스캐너 (G Morales v2.9 WEEKLY BACKTEST DEBUG 완성형)
# =============================================================
# 전략 구성
# A  : 돌파형 종가배팅
...
CLOSING_BET_SCANNER_VERSION = 'G_MORALES_V2_9_WEEKLY_BACKTEST_DEBUG_20260510'
...
def _build_backtest_summary(
    ...
    if selected_df is None or selected_df.empty:
        lines = [
            ...
            "- 데이터 로드 성공이 0개면 FinanceDataReader 또는 네트워크 문제입니다.",
            "- 검사한 일봉 수는 있는데 신호가 0건이면 전략 필터가 과하게 엄격한 상태입니다.",
            "- 먼저 --backtest-weeks 1 --backtest-debug 로 짧게 확인한 뒤 기간을 늘리는 방식이 안전합니다.",
        ]
