...
def main() -> int:
    ap = argparse.ArgumentParser(description='v49.65 immutable universe + search preflight')
    ap.add_argument('--end-date', required=True)
    ap.add_argument('--output-dir', default='v49_65_prepare_output')
    args = ap.parse_args()
    ...
    upath = out / 'v49_65_universe.json'
    ...
    ppath = out / 'v49_65_preflight.json'
