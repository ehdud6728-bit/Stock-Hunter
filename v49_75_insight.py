...
def run_insight_audit(raw:pd.DataFrame, selected_ctx:pd.DataFrame, opp_detail:pd.DataFrame, out:Path,
    ...
    outputs={
        'v49_75_sample_authority_reconciliation.csv':sample_auth,
        'v49_75_immediate_miss_policy_summary.csv':policy_summary,
        'v49_75_immediate_strategic_miss_summary.csv':miss_summary,
        'v49_75_immediate_strategic_miss_feature_contrast.csv':miss_contrast,
        'v49_75_immediate_strategic_miss_casebook.csv':miss_cases,
        'v49_75_immediate_strategic_miss_detail.csv':miss_detail,
        'v49_75_rank_inversion_summary.csv':rank_summary,'v49_75_rank_inversion_feature_stability.csv':rank_features,'v49_75_rank_inversion_cases.csv':rank_cases,
        'v49_75_a_big_vs_stop_summary.csv':a_summary,'v49_75_a_big_vs_stop_feature_stability.csv':a_contrast,'v49_75_a_big_vs_stop_casebook.csv':a_cases,
        'v49_75_h_intent_v2_summary.csv':h_summary,'v49_75_h_intent_v1_v2_matrix.csv':h_matrix,'v49_75_h_intent_v2_condition_pass.csv':h_conditions,'v49_75_h_intent_v2_detail.csv':h_detail,
        'v49_75_hypothesis_registry.csv':registry,
    }
    ...
    manifest={'version':'v49.75','status':status,'audit_scope':'INPUT_LOCK_POLICY_MISS_SAMPLE_AUTHORITY_CORRECTED_INSIGHT',
    ...
    (out/'v49_75_insight_manifest.json').write_text(json.dumps(manifest,ensure_ascii=False,indent=2,default=str),encoding='utf-8')
