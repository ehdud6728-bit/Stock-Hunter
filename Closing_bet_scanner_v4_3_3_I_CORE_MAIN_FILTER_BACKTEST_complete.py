...
# =============================================================
# closing_bet_scanner.py — 종가배팅 타점 스캐너 (v4.3.3 I-CORE MAIN FILTER BACKTEST)
# =============================================================
# 전략 구성
# A  : 돌파형 종가배팅
...
CLOSING_BET_SCANNER_VERSION = 'G_MORALES_V4_3_3_I_CORE_MAIN_FILTER_BACKTEST_20260515'

# v4.3.3 I-CORE strict/supply/main-filter options
...
def _format_i_core_report(df: pd.DataFrame) -> str:
    try:
        ...
        lines = []
        lines.append("[📈 I-CORE 시대중심주 150/200일 시세분출 — v4.3.3 MAIN FILTER]")
        if i.empty:
        ...
        lines.append("- 뉴스/재료 지속성은 이번 v4.3.0에서는 거래대금·월봉거래량·대표성 프록시로만 측정하며, 후속 버전에서 뉴스 누적 저장소와 연결합니다. v4.3.3은 조건 엄격화에 더해 I-4~I-6·재료/거래대금 프록시·OBV20·거래대금 재증가 MAIN 후보를 따로 검증합니다.")
        return "\n".join(lines)
    except Exception as e:
