...
def main() -> int:
    ap = argparse.ArgumentParser(description='v49.62 immutable universe + search preflight')
    ap.add_argument('--end-date', required=True)
    ap.add_argument('--output-dir', default='v49_62_prepare_output')
    args = ap.parse_args()
    ...
    upath = out / 'v49_62_universe.json'
    ...
    ppath = out / 'v49_62_preflight.json'
