...
VERSION="CLOSEBET_LIVE_SHADOW_BOARD_R172_SINGLE_DEDICATED_ROUTE_20260921"
...
# SHADOW deliberately excludes TELEGRAM_DYUL_CHAT_ID / generic TELEGRAM_CHAT_ID
# from automatic/manual delivery resolution. It must use the dedicated close-bet route.
CHAT_KEYS_DEDICATED=[
    "CLOSING_BET_CHAT_ID",
...
def _send_parts(parts):
    ...
    chat_raw,chat_source=_first(CHAT_KEYS_DEDICATED)
    chat,raw_chat_count=_primary_chat(chat_raw)
    ...
    if not token or not chat:
        return {
            ...
            "single_dedicated_route_guard":True,
            "legacy_fallback_chat_disabled":True,
        }
