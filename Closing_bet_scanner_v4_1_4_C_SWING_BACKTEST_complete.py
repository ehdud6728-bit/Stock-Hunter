...
# =============================================================
# closing_bet_scanner.py — 종가배팅 타점 스캐너 (G Morales v4.1.4 C-SWING BACKTEST 완성형)
# =============================================================
# 전략 구성
# A  : 돌파형 종가배팅
...
CLOSING_BET_SCANNER_VERSION = 'G_MORALES_V4_1_4_C_SWING_BACKTEST_20260511'
...
def _build_backtest_summary(
    ...
    lines.append("- v4.1.4부터 C-SWING 평가는 기존 3/5 단타룰과 별도로 계산됩니다. 역매공파는 종가배팅이 아니라 스윙 관심종목으로 해석합니다.")
