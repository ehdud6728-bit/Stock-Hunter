...
# =============================================================
# closing_bet_scanner.py — 종가배팅 타점 스캐너 (G Morales v4.1.3 YMGP STAGE REFINE BACKTEST 완성형)
# =============================================================
# 전략 구성
# A  : 돌파형 종가배팅
...
CLOSING_BET_SCANNER_VERSION = 'G_MORALES_V4_1_3_YMGP_STAGE_REFINE_BACKTEST_20260511'
...
def _build_backtest_summary(
    ...
    lines.append("- v4.1.3부터 C3 눌림완성형은 거래량 감소·재지지·재상승 확인을 요구하는 좁은 2파 준비형으로 재정의됩니다.")
