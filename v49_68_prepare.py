...
def main() -> int:
    ap = argparse.ArgumentParser(description='v49.68 immutable universe + search preflight')
    ap.add_argument('--end-date', required=True)
    ap.add_argument('--output-dir', default='v49_68_prepare_output')
    args = ap.parse_args()
    ...
    # v49.68: immutable entry-time classification maps. These are labels only; no future data.
    ...
    try:
        ...
        print(f'v49.68 listing classification map fallback: {type(exc).__name__}: {exc}')
    ...
    upath = out / 'v49_68_universe.json'
    ...
    ppath = out / 'v49_68_preflight.json'
