...
RESEARCH_ID='REAL_FULL_ORIGINAL_THESIS_FORENSIC_R1_2'
REVISION='R1_2_TAXONOMY_MATCHEDPAIR_EARLYWARNING_20260922'
    ...
    for dt,g in z.groupby('origin_date'):
        ...
        for si,r in s.iterrows():
            ...
            rows.append({
                ...
                'success_ma224_pct':ma1,'failure_ma224_pct':ma2,'success_wave1_pct':w1,'failure_wave1_pct':w2,
...
def run(a):
    ...
    pairs=strict_pairs(disc[pd.to_numeric(disc.get('d20_complete'),errors='coerce').eq(1)]);pairs.to_csv(out/'strict_matched_success_failure_pairs.csv',index=False,encoding='utf-8-sig')
...
def self_test():
    ...
    print('REAL_FULL_ORIGINAL_THESIS_FORENSIC_R1_2_SELF_TEST PASS');return 0
